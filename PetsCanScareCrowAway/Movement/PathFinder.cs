...
namespace PurrplingCore.Movement
{
    public class PathFinder
    {
        ...
        public bool isTileOccupiedIgnoreFloorsOverride(Vector2 tileLocation)
        {
            ...
            {
                foreach (ResourceClump stump in this.w.resourceClumps)
                {
            ...
            if (this.GameLocation.terrainFeatures.ContainsKey(tileLocation) && tileLocationRect.Intersects(this.GameLocation.terrainFeatures[tileLocation].getBoundingBox()) && !this.GameLocation.terrainFeatures[tileLocation].isPassable(null))
            {
                return true;
            }
